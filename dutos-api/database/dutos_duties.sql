...
CREATE TABLE `duties` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  KEY `duty_type_id` (`duty_type_id`),
  CONSTRAINT `duties_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `duties_ibfk_2` FOREIGN KEY (`duty_type_id`) REFERENCES `duty_types` (`id`)
